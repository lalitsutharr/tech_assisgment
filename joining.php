...
if(mysqli_query($conn, $sqlquery)){
	echo "<h3>database stored in a database successfully.";

}
 else{
	echo "ERROR: cannot connect  Sorry $sqlquery. "
		. mysqli_error($conn);
}
...
//email contact
$to = "Assignment@techsolvit.com";
$subject = "Mail From website";
$txt ="FullName = ". $FullName ."\r\n PhoneNumber =" . $PhoneNumber. "\r\n  email = " . $email . "\r\n Message =" . $Message;
$headers = "From:lalit14331@gmail.com" . "\r\n" .
"CC: hyperindia@gmail.com";
if($email!=NULL){
